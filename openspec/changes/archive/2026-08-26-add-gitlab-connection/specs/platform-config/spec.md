...
entered values and reports the outcome in the settings tab. On success it SHALL
name the person the plugin connected as and the access they hold on the
configured project.
...
- **WHEN** the author opens the settings tab, or Obsidian starts with the plugin enabled
